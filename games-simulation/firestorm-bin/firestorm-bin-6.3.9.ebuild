...
MY_P="Phoenix_Firestorm-Betax64_x86_64_${PV}.${REVISION}"
SRC_URI="https://downloads.firestormviewer.org/preview/linux/${MY_P}.tar.xz"
# http://downloads.firestormviewer.org/preview/linux/Phoenix_Firestorm-Betax64_x86_64_6.3.9.58181.tar.xz
