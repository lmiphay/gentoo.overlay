...
MY_PV=$(ver_cut 1-3)
MY_PV=${MY_PV//\./-}
MY_P="Phoenix-Firestorm-Nightlyx64_AVX2-${MY_PV}-${REVISION}"
SRC_URI="
	https://downloads.firestormviewer.org/nightly/linux/${MY_P}.tar.xz
"
# https://downloads.firestormviewer.org/nightly/linux/Phoenix-Firestorm-Nightlyx64_AVX2-7-2-5-81304.tar.xz
...
INST_DIR="opt/firestorm-nightly-bin"
...
src_prepare() {
	...
	eapply "${FILESDIR}/add-unifonts-updated.patch"
...
src_install() {
	...
	dosym /${INST_DIR}/firestorm /usr/bin/firestorm-nightly-bin

	insinto /etc/revdep-rebuild
	doins "${FILESDIR}"/70${PN}

	make_desktop_entry firestorm-nightly-bin "Phoenix Firestorm Nightly Viewer (bin)" /${INST_DIR}/firestorm_icon.png
