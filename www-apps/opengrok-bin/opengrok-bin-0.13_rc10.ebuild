...
SRC_URI="https://github.com/OpenGrok/OpenGrok/releases/download/${MY_PV}/opengrok-${MY_PV}.tar.gz"
...
pkg_postinst() {
	...
	elog "This will also generated the required ${INSTALL_DIR}/etc/configuration.xml"
	elog ""
