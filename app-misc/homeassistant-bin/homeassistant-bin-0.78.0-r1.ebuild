...
src_install() {
	...
	# workaround for: https://github.com/home-assistant/home-assistant/issues/16678
	# even with it zeroconf and ios fail to load
	VIRTUAL_ENV="$INSTALL_DIR" "${D}/$INSTALL_DIR/bin/python3" -m pip --no-cache-dir install --upgrade zeroconf netifaces
